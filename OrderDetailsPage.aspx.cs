...
public partial class Views_OrderDetailsPage : System.Web.UI.Page
{
    ...
    public void bookingdetailslist(string OrderNo)
    {
        ...
        foreach (var item in bookingdetailsList)
        {
             ...
             MainClass.ClientID = item.ClientUserID;
            ...
            OrderDisplayClass.User_UserId = item.CustomerUserID;
        }
            Label_BookingDate.Text = OrderDisplayClass.BookingDate;
            Label_TodayDate.Text = DateTime.UtcNow.ToString();
            Label_OrderNo0.Text = OrderDisplayClass.OrderNo;
            Label_TotalCost.Text = OrderDisplayClass.TotalCost;
            Label_NoOfPersons.Text = OrderDisplayClass.NoOfPersonsAllowed;
            Label_User1.Text = OrderDisplayClass.User1;
            Label_User2.Text = OrderDisplayClass.User2;
            Label_User3.Text = OrderDisplayClass.User3;
            Label_User4.Text = OrderDisplayClass.User4;
            Label_User5.Text = OrderDisplayClass.User5;
            statusord = OrderDisplayClass.Status;

            if (Convert.ToInt32(OrderDisplayClass.NoOfPersonsAllowed) == 1)
            {
            ...
            else if (Convert.ToInt32(OrderDisplayClass.NoOfPersonsAllowed) == 2)
            {
            ...
            else if (Convert.ToInt32(OrderDisplayClass.NoOfPersonsAllowed) == 3)
            {
                Label_User2.Visible = true;
            ...
            else if (Convert.ToInt32(OrderDisplayClass.NoOfPersonsAllowed) == 4)
            {
                Label_User2.Visible = true;
                Label_User3.Visible = true;
            ...
            else if (Convert.ToInt32(OrderDisplayClass.NoOfPersonsAllowed) == 5)
            {
                Label_User2.Visible = true;
                Label_User3.Visible = true;
                Label_User4.Visible = true;
            ...
            try
            {
                if (MainClass.LoginType == 1)
                {
                    ...
                    userdet = ImplementationClass.GetUserDetails(OrderDisplayClass.User_UserId);
                ...
                else if (MainClass.LoginType == 2 || MainClass.LoginType == 3)
                {
    ...
    public void MailSend(string Tomail)
    {
        try
        {
            ...
            message.To.Add(OrderDisplayClass.Emailid);
