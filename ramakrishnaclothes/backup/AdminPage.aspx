...
<body>
 <form id="signupform" runat="server" enctype="multipart/form-data">
    ...
    <p><asp:Label runat="server" ID="lbl_msg"></asp:Label></p>
            ...
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload4" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload5" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload6" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload7" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload8" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload9" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
              <asp:fileupload ID="Fileupload10" runat="server" Width="220px" 
            Height="21px"></asp:fileupload>
           ...
           <asp:ScriptManager ID="ScriptManager1" runat="server">
                        ...
                        &nbsp;<br />
                        <p><asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="Submit" 
                                Width="155px" /></p>
