     ...
     <Columns>
      ...
      Text="Book" ForeColor="#006666" Font-Bold="True"   Font-Underline="True"  />
         ...
         <asp:BoundField DataField="UserID" HeaderText="PG ID" />
                        <asp:BoundField DataField="PGName" HeaderText="PGName"  HeaderStyle-Width="20px" />
                        <asp:BoundField DataField="PGAddress" HeaderText="PGAddress" HeaderStyle-Width="100px" />
                         <asp:BoundField DataField="PGPhno" HeaderText="PGPhno" HeaderStyle-Width="20px" />
                         <asp:BoundField DataField="Avialability" HeaderText="Avialability" HeaderStyle-Width="20px" />
                         <asp:BoundField DataField="CostPerDay" HeaderText="CostPerDay" HeaderStyle-Width="20px" />
                         <asp:BoundField DataField="CostPerMonth" HeaderText="CostPerMonth" HeaderStyle-Width="20px" />
                        <asp:BoundField DataField="Area" HeaderText="Area" HeaderStyle-Width="20px" />
     </Columns>
