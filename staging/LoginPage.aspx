        ...
        */
        function onSignInCallback(authResult) {
            if (authResult['access_token']) {
                ...
                var loc = '/staging/LoginPage.aspx?accessToken=' + authResult['access_token'];
                    ...
                    <form action="#" id="signupform" runat="server"> 
						...
						<a href="pgsaroundpage.html">
                            <asp:Button runat="server" Text="Sign In" 
                                id="buttonsend" onclick="buttonsend_Click" Width="94px"></asp:Button></a>
                        <a>  <button class="g-signin"
