<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeFile="BookingConfirmationPage.aspx.cs" Inherits="Views_BookingConfirmationPage" %>
...
&nbsp;<asp:DropDownList ID="DropDownList2" runat="server" Height="22px" Width="47px">
...
&nbsp;
                    ...
                    <asp:DropDownList ID="DropDownList3" runat="server" Height="22px" Width="47px">
                    <asp:ListItem>1</asp:ListItem>
                         <asp:ListItem>2</asp:ListItem>
                            <asp:ListItem>3</asp:ListItem>
                               <asp:ListItem>4</asp:ListItem>
        ...
        <asp:Button ID="Button_PlaceOrder" runat="server" BackColor="#009999" Font-Bold="True" 
            Font-Underline="True" ForeColor="#006666" Text="Place Order" Width="95px" 
