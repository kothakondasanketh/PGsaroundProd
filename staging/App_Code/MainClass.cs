...
public class ImplementationClass
{
    ...
    public static string UserRegister(UserRegister Userdetails, int update)
    {
    ...
    public static string PGRegister(PGDetails pgdetails, int update)
    {
        string Successfull = null;
        try
        {
    ...
    //public static string BookPG(BookingEntryDetailslocal BEntry)
    //{
    //    try
    //    {
    //        string status = null;
