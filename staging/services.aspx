...
<body>
            ...
            <div class="left-menu">
                ...
                <nav id="mainmenu">
                    <ul id="menu">
                        ...
                        <li class="dropdown selected"><a href="services.aspx">Our Services</a><span class="desc-menu"><a href="services.aspx">At Your Request</span></a>
    ...
    <section id="pagetitle-container">
    	<div class="row">
        	<div class="twelve column">
			<div class="serimg">
			<img src="images/icons/Ourservices.png" alt="">
			</div>
            ...
            <div class="twelve column breadcrumb">
            	<ul>
                    ...
                    <li class="current-page"><a href="services.aspx">Services</a></li>
                </ul>
            </div>
        </div>	        
    </section>
   ...
   <section class="content-wrapper">    
        <div class="row">
            ...
            <div class="four column animated-column no-bg mobile-two">
                ...
                <h4>Selective PG'S</h4>
                <p class="text-overflow">We find you very Furnished, Hygienic and Comfortable PG's</p>
            </div>
            
            <div class="four column animated-column no-bg mobile-two">
            	<div class="flatborder left">
                	<i class="flat-camera small"></i>
                </div>
                <h4>Best Discounts</h4>
                <p class="text-overflow">We provide you PG's with Affordable prices and best discounts</p>  
            </div>
            
            <div class="four column animated-column no-bg mobile-two">
            	<div class="flatborder left">
                	<i class="flat-note small"></i>
                </div>
                <h4>Online Payment</h4>
                <p class="text-overflow">We provide all type of payment options as per the user interest</p>  
            </div>
