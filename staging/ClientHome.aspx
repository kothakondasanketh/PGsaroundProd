...
<body>
	...
	<header>
    	...
    	<div id="top-info">
		  ...
		  <div class="my-sign"> 
          <asp:Label id="UserAccountName" runat="server"></asp:Label> 
        
          <asp:LinkButton ID="LinkButton1" runat="server"  Text="Profile" 
                         BorderColor="White" Font-Bold="false" Font-Italic="False" 
                        Font-Underline="True" ForeColor="#7E8892" style="margin-left: 43px" 
                  onclick="LinkButton1_Click" />
            <asp:LinkButton ID="LinkButton2" runat="server" Text="My Orders" 
                      BorderColor="White" Font-Bold="false" Font-Italic="False" 
                        Font-Underline="True" ForeColor="#7E8892" style="margin-left: 43px" 
            ...
            <div class="left-menu">
                ...
                <nav id="mainmenu">
                    <ul id="menu">
                        ...
                        <li class="dropdown selected"><a href="Home.aspx">PG'S Around</a><span class="desc-menu"><a href="Home.aspx">Feel Like Home</a></span>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="462px" Width="1228px">
    <iframe id="Frame1" runat="server" scrolling="auto"
            style="height: 450px; width: 1148px"></iframe>
    </asp:Panel>
    </div>
