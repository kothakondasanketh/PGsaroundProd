			...
			<div class="twelve column">                    	
				<div class="promo-box">
					...
					<div class="promo-button green">
						<a href="BookingSearchPage.aspx"><h3>Search</h3><i class="icon-chevron-right"></i></a>
					</div>
				</div>                                   
			</div>
		</div>    
				...
				<ul class="block-grid-nomargin three-up mobile-style">
					<li>
						<div class="animated-column text-center btmar">
							...
							<a class="button small white" href="LoginPage.aspx">Sign In</a> <a class="button small white" href="UserRegPage.aspx">New User</a>
					...
					<li>
						<div class="animated-column text-center">
							...
							<p>Client Will Login first so that he can check his PG Updates, Bookings, etc.</p>
							 <a class="button small white" href="ClientLogin.aspx">Sign In</a><a class="button small white" href="ClientRegPage.aspx">New User</a>
						</div>	
					</li>
					<li>
						<div class="animated-column text-center">
							...
							<a class="button small white" href="AdminLogin.aspx">Login Here</a>
						</div>	
					</li>                            
				</ul>
			</div>
