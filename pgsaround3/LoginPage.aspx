    ...
    <!-- header end here -->
    	...
    	<div class="row">
            ...
            <div class="eight column">
            	...
            	<p>'U' 'R' inches away from your new STAY....</p>
                ...
                <div id="signup-form-area">
                    ...
                    <form action="#" id="signupform" runat="server"> 
						...
						<a href="pgsaroundpage.html"><asp:Button runat="server" Text="Sign In" 
                                id="buttonsend" onclick="buttonsend_Click"></asp:Button></a>
                        <a> <asp:ImageButton ID="ImageButton2" runat="server" 
                        CommandArgument="https://www.google.com/accounts/o8/id" Height="26px" 
                        ImageUrl="~/Images/google-login.png" oncommand="ImageButton2_Click" Width="173px" 
                              /></a>
                        <br />
