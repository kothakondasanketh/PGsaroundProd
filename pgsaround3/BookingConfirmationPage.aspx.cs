...
public partial class Views_BookingConfirmationPage : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        BEntry.OrderNo = "PGS" + GeneratedOrderNo;
        ...
        if (i > 0)
        {
            Label_OrderSubmit.Text = "Congractulations your Order is Succesfull..... Your Order No is : PGS" + GeneratedOrderNo + "";
            Button_PlaceOrder.Visible = false;
            CCpaymentDiv.Visible = false;
            ...
            MainClass.OrderNo = "PGS" + GeneratedOrderNo;
