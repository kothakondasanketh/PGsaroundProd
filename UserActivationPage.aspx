            ...
            <div class="left-menu">
                ...
                <nav id="mainmenu">
                    <ul id="menu">
                        ...
                        <li class="dropdown"><a href="Home.aspx">PG'S Around</a><span class="desc-menu"><a href="Home.aspx">Feel Like Home</a></span>
    ...
    <!-- header end here -->
    	...
    	<div class="row">
            ...
            <div class="eight column">
                ...
                <p><asp:Label runat="server" ID="Message"></asp:Label></p>
                <div id="Register-form-area">
                    <!-- Register Form Start //-->
                    <form id="Form1" runat="server"> <fieldset> 
